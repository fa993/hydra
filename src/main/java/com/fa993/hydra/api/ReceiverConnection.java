...
public interface ReceiverConnection {
     ...
     * Impl Note: The returned transaction object must have a non-null {@link TransactionResult} field and for a successful transaction have a non-null {@link State}
     *
